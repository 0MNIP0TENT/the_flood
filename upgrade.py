...
ZERGFLYERARMORSLEVEL1,ZERGFLYERARMORSLEVEL2,ZERGFLYERARMORSLEVEL3,SPIRE      
import common
...
ZERGFLYERWEAPONSLEVEL3:[SPIRE,SPAWNINGPOOL,LAIR,ZERGFLYERWEAPONSLEVEL1,ZERGFLYERWEAPONSLEVEL2,HIVE],    
ZERGFLYERARMORSLEVEL1:[SPIRE,SPAWNINGPOOL],
ZERGFLYERARMORSLEVEL2:[SPIRE,SPAWNINGPOOL,LAIR,ZERGFLYERARMORSLEVEL1],
ZERGFLYERARMORSLEVEL3:[SPIRE,SPAWNINGPOOL,LAIR,ZERGFLYERARMORSLEVEL1,ZERGFLYERARMORSLEVEL2,HIVE],    
...
ZERGGROUNDARMORSLEVEL3:[EVOLUTIONCHAMBER,EVOLUTIONCHAMBER,ZERGGROUNDARMORSLEVEL2,ZERGMISSILEWEAPONSLEVEL1,HIVE,LAIR,SPAWNINGPOOL],
ZERGMISSILEWEAPONSLEVEL1:[EVOLUTIONCHAMBER],
ZERGMISSILEWEAPONSLEVEL2:[EVOLUTIONCHAMBER,EVOLUTIONCHAMBER,ZERGMISSILEWEAPONSLEVEL1,LAIR,SPAWNINGPOOL],
ZERGMISSILEWEAPONSLEVEL3:[EVOLUTIONCHAMBER,EVOLUTIONCHAMBER,ZERGMISSILEWEAPONSLEVEL1,ZERGGROUNDARMORSLEVEL2,ZERGMISSILEWEAPONSLEVEL1,HIVE,LAIR,SPAWNINGPOOL],  
ZERGMELEEWEAPONSLEVEL1:[EVOLUTIONCHAMBER],
ZERGMELEEWEAPONSLEVEL2:[EVOLUTIONCHAMBER,ZERGMELEEWEAPONSLEVEL1,LAIR,SPAWNINGPOOL],
ZERGMELEEWEAPONSLEVEL3:[EVOLUTIONCHAMBER,ZERGMELEEWEAPONSLEVEL1,ZERGMELEEWEAPONSLEVEL2,HIVE,LAIR,SPAWNINGPOOL],    
ZERGLINGATTACKSPEED:[SPAWNINGPOOL,LAIR,HIVE,INFESTATIONPIT],    
ZERGLINGMOVEMENTSPEED:[SPAWNINGPOOL]
}
requirment = {
SPIRE:LAIR,
...
async def research_upgrades(self):
    await upgrade_anything(self,ZERGFLYERARMORSLEVEL3)
